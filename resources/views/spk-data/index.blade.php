                                ...
                                <tbody>
                                    ...
                                    <tr id="details-1" style="display: none;">
                                        <td colspan="10">
                                            ...
                                            <h6>Nama Perhitungan 1</h6>
                                            <table class="table table-bordered table-md">
                                                <tr>
                                                    <th>Nama Konten Youtube</th>
                                                    <th>C1</th>
                                                    <th>C2</th>
                                                    <th>C3</th>
                                                    <th>C4</th>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-md">
                                <tbody>
                                    ...
                                    <tr id="details-2" style="display: none;">
                                        <td colspan="10">

                                            <h6>Nama Perhitungan 2</h6>
                                            <table class="table table-bordered table-md">
                                                <tr>
                                                    <th>Nama Konten Youtube</th>
                                                    <th>C1</th>
                        ...
                        <div class="table-responsive">
                            <table class="table table-bordered table-md">
                                <tbody>
                                    ...
                                    <tr id="details-3" style="display: none;">
                                        <td colspan="10">

                                            <h6>Nama Perhitungan 3</h6>
                                            <table class="table table-bordered table-md">
                                                <tr>
                                                    <th>Nama Konten Youtube</th>
                                                    <th>C1</th>
